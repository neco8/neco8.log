                ...
                (List.map
                    (\(ListItem task item) ->
                        ...
                        li [ class "relative pl-2" ]
                            (div
                                [ class "before:content-['•'] before:font-light before:absolute before:-left-1 before:text-stone-600 grid grid-flow-col py-2 items-center justify-start group"
                                ]
                                [ span
                                    [ case task of
                                        NoTask ->
                ...
                (List.indexedMap
                    (\idx item ->
                        ...
                        li [ class "relative pl-2 items-center" ]
                            [ div
                                [ class "relative grid grid-flow-col py-2 items-center justify-start group" ]
                                -- ここでマーカーを表示、select-noneでコピー不可に
                                [ span [ class "select-none absolute -left-1 -translate-x-full" ]
                                    [ text <|
